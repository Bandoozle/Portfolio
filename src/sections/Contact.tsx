  ...
  const contactInfo = [
    {
      icon: Mail,
      label: 'Email',
      value: 'smarcoareliano@gmail.com',
    ...
    },
    {
      icon: Linkedin,
      label: 'LinkedIn',
      value: 'linkedin.com/in/marcosuteja',
      ...
      <div className="relative container mx-auto px-6 z-10">
        ...
        >
          ...
          <div className="flex justify-center gap-6">
            {[
              { icon: Github, href: 'https://github.com/Bandoozle', label: 'GitHub' },
              { icon: Linkedin, href: 'https://linkedin.com/in/marcosuteja', label: 'LinkedIn' },
            ].map((social) => {
