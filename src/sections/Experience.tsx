...
const experiences: ExperienceItem[] = [
  {
    ...
    description: (
      <div className="space-y-2 text-left">
        <p>Built pro-bono software solutions for non-profit organizations as part of SFU's student-run tech club.</p>
        <ul className="list-disc list-inside space-y-1 text-sm">
          <li>Developed and shipped full-stack features for non-profit clients using React and Node.js</li>
          <li>Collaborated in agile sprints with designers, PMs, and fellow developers</li>
          <li>Participated in code reviews and contributed to team engineering standards</li>
          <li>Delivered accessible, user-focused interfaces for real-world organizational needs</li>
        </ul>
      </div>
    )
  },
  ...
  },
  {
    ...
    description: (
      <div className="space-y-2 text-left">
        ...
        <p><strong>Activities:</strong> SFU Blueprint, AI/ML Club, Hackathon Participant, Open Source Contributor</p>
      </div>
    )
  }
]
