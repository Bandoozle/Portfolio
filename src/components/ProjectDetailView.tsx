...
const ProjectDetailView = ({ project, onClose }: ProjectDetailViewProps) => {
  ...
  return (
    <motion.div
      ...
      className="fixed inset-0 z-[120] flex items-end sm:items-center justify-center bg-[#0B0B0A]/92 p-0 sm:p-4 md:p-6"
      role="dialog"
      aria-modal="true"
    ...
    >
      <motion.article
        ...
        className="relative flex max-h-[94vh] w-full max-w-[1100px] flex-col overflow-hidden bg-[#191816] text-[#E5E5E0] sm:max-h-[88vh] sm:rounded-[4px]"
