          ...
          >
            <div className="glass p-8 rounded-xl border-l-4 border-[#E9A53F]">
              ...
              <p className="text-white/90 leading-relaxed mb-4 text-left">
                I'm a Computer Science graduate from Simon Fraser University, passionate about leveraging 
              ...
              <p className="text-white/90 leading-relaxed mb-4 text-left">
                My journey spans end-to-end ML pipelines, full-stack applications, and volunteer software development through 
                <span className="text-[#00E5C4] font-semibold"> SFU Blueprint</span>, where I built tech solutions for non-profit organizations. I love exploring the intersection of 
            ...
            >
              ...
              <div className="space-y-3 font-mono text-sm">
                ...
                <div className="space-y-2 text-white/90 pl-2">
                  ...
                  <div><span className="text-[#00E5C4]">Location:</span> Burnaby, BC 🇨🇦</div>
                  <div><span className="text-[#00E5C4]">Education:</span> SFU - BSc Computer Science</div>
                  <div><span className="text-[#00E5C4]">Specialization:</span> AI & Machine Learning</div>
                  <div><span className="text-[#00E5C4]">Status:</span> <span className="text-[#E9A53F]">Open to Opportunities</span></div>
                </div>
                ...
                <div className="pl-2 text-white/80 space-y-3">
                  {[
                    { category: 'Languages', items: ['Python', 'SQL', 'JS', 'TS', 'Java', 'C++'] },
                    { category: 'ML & Data', items: ['PyTorch', 'TensorFlow', 'NumPy', 'Pandas'] },
                    { category: 'Frontend', items: ['React', 'Next.js', 'HTML', 'CSS', 'Tailwind'] },
                    { category: 'Backend', items: ['FastAPI', 'Docker', 'Vercel', 'Render'] },
                    { category: 'Databases', items: ['PostgreSQL', 'Firestore', 'Convex'] },
                  ].map(({ category, items }) => (
                    <div key={category}>
                      <div className="text-[#E9A53F] text-xs mb-1">{category}/</div>
                      <div className="grid grid-cols-2 gap-x-4 gap-y-1">
                        {items.map((item) => (
                          <div key={item} className="flex items-center gap-2">
                            <span className="text-[#00E5C4]">📁</span> {item}
                          </div>
                        ))}
                      </div>
                    </div>
